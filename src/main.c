...
int main() {
    ...
    if (ret < 0) {
        ...
        printf("  Check wiring:\n");
        printf("    SDA â†’ GPIO 2 (pin 4)\n");
        printf("    SCL â†’ GPIO 3 (pin 5)\n");
        printf("    VCC â†’ 3.3V\n");
        printf("    GND â†’ GND\n");
        fflush(stdout);
    ...
    while (true) {
        ...
        printf("  Gyro:  X=%7.2fÂ°/s Y=%7.2fÂ°/s Z=%7.2fÂ°/s\n", gx, gy, gz);
        printf("\n");
        fflush(stdout);
